...
let
  ...
  manual-combined = runCommand "nixos-manual-combined"
    { inherit sources;
      buildInputs = [ libxml2 libxslt jing ];
    ...
    ''
      ...
      jing ${docbook5}/xml/rng/docbook/docbook.rng ./manual-combined.xml
      jing ${docbook5}/xml/rng/docbook/docbook.rng ./man-pages-combined.xml
